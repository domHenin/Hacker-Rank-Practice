package com.hackerrank.practices.JavaOutputFormatting;

import java.util.Scanner;

public class OutputtingMain {
    public static void main(String[] args) {
//        System.out.println("to GOD all glory, and all honor!");
...
//        characters. The leading digit of the integer is the 16th character, and each integer that was less than digits now has leading zeroes.
